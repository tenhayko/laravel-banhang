						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
									...
									<div class="cart-item">
										...
										<div class="media">
											...
											<div class="media-body">
												...
												<span class="cart-item-amount">{{$product['qty']}}*<span>{{($product['item']['promotion_price']==0)?number_format($product['item']['unit_price'],0,',','.'):number_format($product['item']['promotion_price'],0,',','.')}}</span></span>
											</div>
										</div>
									</div>
								@endforeach
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{number_format(Session('cart')->totalPrice,0,',','.')}}</span></div>
									<div class="clearfix"></div>
